$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Shreya and Saurabh's Wedding",

            // Event start date
            start: new Date('Dec 06, 2024 10:00'),
            ...
            end: new Date('Dec 08, 2024 09:00'),

            // Event Address
            address: 'The Grand Shekhawati Hotel, Churu, Rajasthan',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Mr. SK Surana at +91-9444410816."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 28.26663, lng: 74.95685};
...
function initBBSRMap() {
    var la_fiesta = {lat: 28.26663, lng: 74.95685};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
